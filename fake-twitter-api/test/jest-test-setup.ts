...
process.env.JWT_REFRESH_SECRET =
  process.env.TEST_JWT_REFRESH_SECRET || generateTestSecret(64);
process.env.JWT_ACCESS_TOKEN_EXPIRATION =
  process.env.TEST_JWT_ACCESS_TOKEN_EXPIRATION || '15m';
process.env.JWT_REFRESH_TOKEN_EXPIRATION =
  process.env.TEST_JWT_REFRESH_TOKEN_EXPIRATION || '7d';
...
process.env.DB_PASSWORD =
  process.env.TEST_DB_PASSWORD || 'fake_twitter_password';
...
process.env.POSTGRES_USER =
  process.env.TEST_POSTGRES_USER || 'fake_twitter_user';
process.env.POSTGRES_PASSWORD =
  process.env.TEST_POSTGRES_PASSWORD || 'fake_twitter_password';
process.env.POSTGRES_DB = process.env.TEST_POSTGRES_DB || 'fake_twitter_db';
process.env.POSTGRES_DB_TEST =
  process.env.TEST_POSTGRES_DB_TEST || 'fake_twitter_test';
process.env.POSTGRES_SCHEMA =
  process.env.TEST_POSTGRES_SCHEMA || 'fake_twitter_schema';
