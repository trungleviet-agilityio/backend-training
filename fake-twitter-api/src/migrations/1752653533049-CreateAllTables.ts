...
export class CreateAllTables1752653533049 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "auth_password_resets" ADD CONSTRAINT "FK_0f77870be00234c8d2302df9944" FOREIGN KEY ("user_uuid") REFERENCES "users"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth_sessions" ADD CONSTRAINT "FK_642b9108878d0313a02579b900a" FOREIGN KEY ("user_uuid") REFERENCES "users"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_f279fbcabd34bb5147cfb9a6508" FOREIGN KEY ("author_uuid") REFERENCES "users"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_5455c71d4dac683e4cffa09b508" FOREIGN KEY ("post_uuid") REFERENCES "posts"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_6a0b89d7f2830803ead6287cae0" FOREIGN KEY ("parent_uuid") REFERENCES "comments"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_cb928c69dc753e7218ab4ab2b28" FOREIGN KEY ("author_uuid") REFERENCES "users"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" DROP CONSTRAINT "FK_cb928c69dc753e7218ab4ab2b28"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_6a0b89d7f2830803ead6287cae0"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_5455c71d4dac683e4cffa09b508"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_f279fbcabd34bb5147cfb9a6508"`);
        await queryRunner.query(`ALTER TABLE "auth_sessions" DROP CONSTRAINT "FK_642b9108878d0313a02579b900a"`);
        await queryRunner.query(`ALTER TABLE "auth_password_resets" DROP CONSTRAINT "FK_0f77870be00234c8d2302df9944"`);
